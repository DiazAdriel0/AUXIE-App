            ...
            <div>
                <section className={style.layout}>
                    ...
                    <div>
                        ...
                        <h4>
                            Conecta con el AUXIE que mejor se
                            adecue a vos.
                        </h4>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <img src={GuaranteesIcon} alt="Garantees Icon" style={{ width: '300px', height: '300px' }}/>
            ...
            <div>
                <section className={style.Footer}>
                    <div className={style.Register}>
                        ...
                        <Link to='/auxieform'><h1>Quiero ser un AUXIE</h1></Link>
                    </div>
                    <div className={style.Register}>
                        <Link to='/clientform'><h1>Necesito un AUXIE</h1></Link>
                    </div>
                </section>
            </div>
        </div>
