...
import GaranteesIcon from '../../../assets/Logos/GuaranteesIcon.svg'
            ...
            <div>
                <div className={style.offers}>
                    ...
                    <button className={style.button}>
                        <Link to="/home">Explora la app</Link>
                    </button>
                </div>
            </div>
            <div>
            ...
            <div>
                <section className={style.Footer}>
                    <div className={style.Register}>
                        ...
                        <h1>
                            <Link to="auxieform">Quiero ser un AUXIE</Link>
                        </h1>
                    </div>
                    <div className={style.Register}>
                        <h1>
                            <Link to="clientform">Necesito un AUXIE</Link>
                        </h1>
                    </div>
                </section>
            </div>
